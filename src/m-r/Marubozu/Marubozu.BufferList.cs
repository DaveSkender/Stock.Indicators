...
{
    private readonly double _minBodyPercent;
    ...
    public MarubozuList(double minBodyPercent = 95)
    {
        ...
        _minBodyPercent = minBodyPercent / 100;
    }
    ...
    public void Add(IQuote quote)
    {
        ...
        if (candle.BodyPct >= _minBodyPercent)
        {
    ...
    {
        base.Clear();
        // No internal buffers to clear for this pattern
    }
}
...
{
    /// <summary>
    /// Creates a buffer list for Marubozu candlestick pattern detection.
    /// </summary>
