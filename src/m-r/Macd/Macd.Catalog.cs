...
{
    /// <summary>
    /// Catalog listing for the Moving Average Convergence Divergence (MACD) indicator.
    /// </summary>
    public static readonly IndicatorListing Listing = new IndicatorListingBuilder()
        ...
        .AddParameter<int>("fastPeriods", "Fast Periods",
            description: "Number of periods for the fast EMA",
            isRequired: false,
            defaultValue: 12,
            minimum: 1,
            maximum: 200)
        .AddParameter<int>("slowPeriods", "Slow Periods",
            description: "Number of periods for the slow EMA",
            isRequired: false,
            defaultValue: 26,
            minimum: 1,
            maximum: 250)
        .AddParameter<int>("signalPeriods", "Signal Periods",
            description: "Number of periods for the signal line",
            isRequired: false,
            defaultValue: 9,
            minimum: 1,
            maximum: 50)
        .AddResult("Macd", "MACD", ResultType.Default, isDefault: true)
        .AddResult("Signal", "Signal", ResultType.Default, isDefault: false)
        .AddResult("Histogram", "Histogram", ResultType.Bar, isDefault: false)
        .Build();
}
