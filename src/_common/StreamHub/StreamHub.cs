...
#region adapter for safe IReusable list access
...
/// </remarks>
internal sealed class ReusableListAdapter<TIn> : IReadOnlyList<IReusable>
    where TIn : IReusable
{
    private readonly IReadOnlyList<TIn> _source;

    public ReusableListAdapter(IReadOnlyList<TIn> source)
    {
