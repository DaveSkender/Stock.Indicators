...
public static partial class Catalog
{
    ...
    private static partial IReadOnlyList<IndicatorListing> GeneratedListings { get; }
    ...
    /// </returns>
    public static IReadOnlyList<IndicatorListing> Get() =>
        [.. GeneratedListings.OrderBy(x => x.Name)];
