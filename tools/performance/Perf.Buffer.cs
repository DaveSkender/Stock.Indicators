...
public class BufferIndicators
{
    ...
    [Benchmark] public DynamicList DynamicList() => q.ToDynamicList(20);
    [Benchmark] public ElderRayList ElderRayList() => q.ToElderRayList();
    [Benchmark] public EmaList EmaList() => q.ToEmaList(20);
    [Benchmark] public EpmaList EpmaList() => q.ToEpmaList(n);
    [Benchmark] public FcbList FcbList() => q.ToFcbList(n);
    [Benchmark] public FisherTransformList FisherTransformList() => q.ToFisherTransformList(10);
    [Benchmark] public ForceIndexList ForceIndexList() => q.ToForceIndexList(13);
    ...
    [Benchmark] public KeltnerList KeltnerList() => q.ToKeltnerList();
    [Benchmark] public KvoList KvoList() => q.ToKvoList();
    ...
    [Benchmark] public MarubozuList MarubozuList() => q.ToMarubozuList();
    [Benchmark] public MfiList MfiList() => q.ToMfiList();
    ...
    [Benchmark] public SmaAnalysisList SmaAnalysisList() => q.ToSmaAnalysisList(10);
    ...
    [Benchmark] public StdDevList StdDevList() => q.ToStdDevList(20);
    ...
    [Benchmark] public SuperTrendList SuperTrendList() => q.ToSuperTrendList();
    [Benchmark] public T3List T3List() => q.ToT3List(5, 0.7);
    [Benchmark] public TemaList TemaList() => q.ToTemaList(20);
    ...
    [Benchmark] public VwapList VwapList() => q.ToVwapList(q[0].Timestamp);
