...
public class Program
{
    private static void Main(string[] args)
    {
        ...
        //IEnumerable<AdlResult> adlT = tuples.GetAdl();
        IEnumerable<AdxResult> adx1 = quotes.GetAdx(lookbackPeriods: 14);
        //IEnumerable<AdxResult> adxT = tuples.GetAdx(lookbackPeriods: 14);
        ...
        //IEnumerable<AroonResult> aroonT = tuples.GetAroon(lookbackPeriods: 25);
        IEnumerable<AtrResult> atr1 = quotes.GetAtr(lookbackPeriods: 14);
        //IEnumerable<AtrResult> atrT = tuples.GetAtr(lookbackPeriods: 14);
        ...
        //IEnumerable<AtrStopResult> atrStopT = tuples.GetAtrStop(lookbackPeriods: 21, multiplier: 3, endType: EndType.Close);
        ...
        //IEnumerable<BetaResult> betaT = tuples.GetBeta(quotesMarket: tuples, lookbackPeriods: 20);
        ...
        //IEnumerable<BopResult> bopT = tuples.GetBop(smoothPeriods: 14);
        ...
        //IEnumerable<CciResult> cciT = tuples.GetCci(lookbackPeriods: 20);
        ...
        //IEnumerable<ChaikinOscResult> chaikinOscT = tuples.GetChaikinOsc(fastPeriods: 3, slowPeriods: 10);
        IEnumerable<ChandelierResult> chandelier1 = quotes.GetChandelier(lookbackPeriods: 22, multiplier: 3, type: ChandelierType.Long);
        //IEnumerable<ChandelierResult> chandelierT = tuples.GetChandelier(lookbackPeriods: 22, multiplier: 3, type: ChandelierType.Long);
        IEnumerable<ChopResult> chop1 = quotes.GetChop(lookbackPeriods: 14);
        //IEnumerable<ChopResult> chopT = tuples.GetChop(lookbackPeriods: 14);
        IEnumerable<CmfResult> cmf1 = quotes.GetCmf(lookbackPeriods: 20);
        //IEnumerable<CmfResult> cmfT = tuples.GetCmf(lookbackPeriods: 20);
        ...
        //IEnumerable<CorrResult> corrT = tuples.GetCorrelation(quotesB: quotes, lookbackPeriods: 20);
        ...
        //IEnumerable<DonchianResult> donchianT = tuples.GetDonchian(lookbackPeriods: 20);
        ...
        //IEnumerable<ElderRayResult> elderRayT = tuples.GetElderRay(lookbackPeriods: 13);
        ...
        //IEnumerable<FcbResult> fcbT = tuples.GetFcb(windowSpan: 2);
        ...
        //IEnumerable<ForceIndexResult> forceIndexT = tuples.GetForceIndex(lookbackPeriods: 2);
        ...
        //IEnumerable<FractalResult> fractalT = tuples.GetFractal(leftSpan: 2, rightSpan: 2, endType: EndType.HighLow);
        ...
        //IEnumerable<HeikinAshiResult> heikinAshiT = tuples.GetHeikinAshi();
        ...
        //IEnumerable<IchimokuResult> ichimokuT = tuples.GetIchimoku(tenkanPeriods: 9, kijunPeriods: 26, senkouBPeriods: 52);
        ...
        //IEnumerable<KeltnerResult> keltnerT = tuples.GetKeltner(emaPeriods: 20, multiplier: 2, atrPeriods: 10);
        ...
        //IEnumerable<KvoResult> kvoT = tuples.GetKvo(fastPeriods: 34, slowPeriods: 55, signalPeriods: 13);
        ...
        //IEnumerable<MfiResult> mfiT = tuples.GetMfi(lookbackPeriods: 14);
        IEnumerable<ObvResult> obv1 = quotes.GetObv();
        IEnumerable<ObvResult> obv2 = quotes.GetObv(smaPeriods: 3);
        //IEnumerable<ObvResult> obvT = tuples.GetObv();
        ...
        //IEnumerable<ParabolicSarResult> pSarT = tuples.GetParabolicSar(accelerationStep: 0.02, maxAccelerationFactor: 0.2);
        ...
        //IEnumerable<PivotPointsResult> pivotPointsT = tuples.GetPivotPoints(windowSize: PeriodSize.Week);
        ...
        //IEnumerable<PivotsResult> pivotsT = tuples.GetPivots(leftSpan: 2, rightSpan: 2, maxTrendPeriods: 20, endType: EndType.HighLow);
        ...
        //IEnumerable<PrsResult> prsT = tuples.GetPrs(quotesBase: tuples, lookbackPeriods: 5, smaPeriods: 3);
        IEnumerable<PvoResult> pvo1 = quotes.GetPvo();
        //IEnumerable<PvoResult> pvoT = tuples.GetPvo();
        ...
        IEnumerable<RollingPivotsResult> rollingPivots1 = quotes.GetRollingPivots(windowPeriods: 14, offsetPeriods: 7, pointType: PivotPointType.Standard);
        //IEnumerable<RollingPivotsResult> rollingPivotsT = tuples.GetRollingPivots(windowPeriods: 14, offsetPeriods: 7, pointType: PivotPointType.Standard);
        ...
        //IEnumerable<SmiResult> smiT = tuples.GetSmi(lookbackPeriods: 13, firstSmoothPeriods: 25, secondSmoothPeriods: 2, signalPeriods: 3);
        ...
        //IEnumerable<StarcBandsResult> starcBandsT = tuples.GetStarcBands(smaPeriods: 20, multiplier: 2, atrPeriods: 10);
        ...
        //IEnumerable<StochResult> stochT = tuples.GetStoch(lookbackPeriods: 14, signalPeriods: 3, smoothPeriods: 3);
        ...
        //IEnumerable<SuperTrendResult> superTrendT = tuples.GetSuperTrend(lookbackPeriods: 10, multiplier: 3);
        ...
        //IEnumerable<UltimateResult> ultimateT = tuples.GetUltimate(shortPeriods: 7, middlePeriods: 14, longPeriods: 28);
        ...
        //IEnumerable<VolatilityStopResult> volStopT = tuples.GetVolatilityStop(lookbackPeriods: 7, multiplier: 3);
        IEnumerable<VortexResult> vortex1 = quotes.GetVortex(lookbackPeriods: 14);
        //IEnumerable<VortexResult> vortexT = tuples.GetVortex(lookbackPeriods: 14);
        IEnumerable<VwapResult> vwap1 = quotes.GetVwap();
        //IEnumerable<VwapResult> vwapT = tuples.GetVwap();
        IEnumerable<VwmaResult> vwma1 = quotes.GetVwma(lookbackPeriods: 20);
        //IEnumerable<VwmaResult> vwmaT = tuples.GetVwma(lookbackPeriods: 20);
        IEnumerable<WilliamsResult> williamsR = quotes.GetWilliamsR(lookbackPeriods: 14);
        //IEnumerable<WilliamsResult> williamsRT = tuples.GetWilliamsR(lookbackPeriods: 14);
        ...
        //IEnumerable<ZigZagResult> zigZagT = tuples.GetZigZag(endType: EndType.Close, percentChange: 5);
        ...
        //IEnumerable<AdlResult> adl2 = tuples.GetAdl();
        //IEnumerable<AdxResult> adx2 = tuples.GetAdx(lookbackPeriods: 14);
        //IEnumerable<AroonResult> aroonT = tuples.GetAroon(lookbackPeriods: 25);
        //IEnumerable<AtrResult> atrT = tuples.GetAtr(lookbackPeriods: 14);
        //IEnumerable<AtrStopResult> atrStopT = tuples.GetAtrStop(lookbackPeriods: 21, multiplier: 3, endType: EndType.Close);
        //IEnumerable<AwesomeResult> awesomeT = tuples.GetAwesome(fastPeriods: 5, slowPeriods: 34);
        //IEnumerable<BetaResult> betaT = tuples.GetBeta(quotesMarket: quotes, lookbackPeriods: 20);
        //IEnumerable<BollingerBandsResult> bbT = tuples.GetBollingerBands(lookbackPeriods: 20, standardDeviations: 2);
        //IEnumerable<BopResult> bopT = tuples.GetBop(smoothPeriods: 14);
        //IEnumerable<CciResult> cciT = tuples.GetCci(lookbackPeriods: 20);
        //IEnumerable<ChaikinOscResult> chaikinOscT = tuples.GetChaikinOsc(fastPeriods: 3, slowPeriods: 10);
        ...
        //IEnumerable<CmfResult> cmfT = tuples.GetCmf(lookbackPeriods: 20);
        //IEnumerable<CmoResult> cmoT = tuples.GetCmo(lookbackPeriods: 14);
        //IEnumerable<ConnorsRsiResult> connorsRsiT = tuples.GetConnorsRsi(rsiPeriods: 3, streakPeriods: 2, rankPeriods: 100);
        //IEnumerable<CorrResult> corrT = tuples.GetCorrelation(quotesB: quotes, lookbackPeriods: 20);
        //IEnumerable<DemaResult> demaT = tuples.GetDema(lookbackPeriods: 20);
        //IEnumerable<DonchianResult> donchianT = tuples.GetDonchian(lookbackPeriods: 20);
        //IEnumerable<DpoResult> dpoT = tuples.GetDpo(lookbackPeriods: 20);
        ...
        //IEnumerable<KvoResult> kvoT = tuples.GetKvo(fastPeriods: 34, slowPeriods: 55, signalPeriods: 13);
        //IEnumerable<MacdResult> macdT = tuples.GetMacd(fastPeriods: 12, slowPeriods: 26, signalPeriods: 9);
        //IEnumerable<MaEnvelopeResult> maEnvelopesT = tuples.GetMaEnvelopes(lookbackPeriods: 20, percentOffset: 3.5, movingAverageType: MaType.SMA);
        //IEnumerable<MamaResult> mamaT = tuples.GetMama(fastLimit: 0.5, slowLimit: 0.05);
        //IEnumerable<MfiResult> mfiT = tuples.GetMfi(lookbackPeriods: 14);
        //IEnumerable<ObvResult> obvT = tuples.GetObv();
        //IEnumerable<ParabolicSarResult> pSarT = tuples.GetParabolicSar(accelerationStep: 0.02, maxAccelerationFactor: 0.2);
        ...
        //IEnumerable<PivotsResult> pivotsT = tuples.GetPivots(leftSpan: 2, rightSpan: 2, maxTrendPeriods: 20, endType: EndType.HighLow);
        //IEnumerable<PmoResult> pmoT = tuples.GetPmo(timePeriods: 35, smoothPeriods: 20, signalPeriods: 10);
        //IEnumerable<PrsResult> prsT = tuples.GetPrs(quotesBase: quotes, lookbackPeriods: 5, smaPeriods: 3);
        //IEnumerable<PvoResult> pvoT = tuples.GetPvo();
        //IEnumerable<RocResult> rocT = tuples.GetRoc(lookbackPeriods: 20);
        //IEnumerable<RocWbResult> rocWbT = tuples.GetRocWb(lookbackPeriods: 20, emaPeriods: 9, stdDevPeriods: 2);
        //IEnumerable<RollingPivotsResult> rollingPivotsT = tuples.GetRollingPivots(windowPeriods: 14, offsetPeriods: 7, pointType: PivotPointType.Standard);
        ...
        //IEnumerable<StarcBandsResult> starcBandsT = tuples.GetStarcBands(smaPeriods: 20, multiplier: 2, atrPeriods: 10);
        //IEnumerable<StcResult> stcT = tuples.GetStc(cyclePeriods: 10, fastPeriods: 23, slowPeriods: 50);
        //IEnumerable<StdDevChannelsResult> stdDevChannelsT = tuples.GetStdDevChannels(lookbackPeriods: 20, stdDeviations: 2);
        //IEnumerable<StdDevResult> stdDevT = tuples.GetStdDev(lookbackPeriods: 20);
        //IEnumerable<StochResult> stochT = tuples.GetStoch(lookbackPeriods: 14, signalPeriods: 3, smoothPeriods: 3);
        //IEnumerable<StochRsiResult> stochRsiT = tuples.GetStochRsi(rsiPeriods: 14, stochPeriods: 14, signalPeriods: 3, smoothPeriods: 3);
        //IEnumerable<SuperTrendResult> superTrendT = tuples.GetSuperTrend(lookbackPeriods: 10, multiplier: 3);
