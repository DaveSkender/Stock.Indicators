...
public class MamaTests : TestBase
{
    ...
    public void MamaSeriesListing()
    {
        ...
        IndicatorParam fastLimitParam = listing.Parameters.SingleOrDefault(p => p.ParameterName == "fastLimit");
        fastLimitParam.Should().NotBeNull();
        IndicatorParam slowLimitParam1 = listing.Parameters.SingleOrDefault(p => p.ParameterName == "slowLimit");
