...
namespace Internal.Tests
{
    ...
    public class PivotPoints : TestBase
    {
        ...
        public void Standard()
        {
            ...
            Assert.AreEqual(206.4800m, Math.Round((decimal)r2.S3, 4));
            ...
            Assert.AreEqual(222.9800m, Math.Round((decimal)r2.R3, 4));
            ...
            Assert.AreEqual(223.5000m, Math.Round((decimal)r3.S3, 4));
            ...
            Assert.AreEqual(245.4300m, Math.Round((decimal)r3.R3, 4));
            ...
            Assert.AreEqual(237.6233m, Math.Round((decimal)r4.S3, 4));
            ...
            Assert.AreEqual(267.5933m, Math.Round((decimal)r4.R3, 4));
            ...
            Assert.AreEqual(242.8633m, Math.Round((decimal)r5.S3, 4));
            ...
            Assert.AreEqual(269.3533m, Math.Round((decimal)r5.R3, 4));
            ...
            Assert.AreEqual(241.2533m, Math.Round((decimal)r6.S3, 4));
            ...
            Assert.AreEqual(294.3833m, Math.Round((decimal)r6.R3, 4));
