...
public class PmoTests : TestBase
{
    ...
    public void PmoSeriesFromCatalogMatchesDirectCall()
    {
        ...
        {
            directResults = quotes.ToPmo(parameters[0]);
        }
        else if (parameters.Length == 2)
        {
            directResults = quotes.ToPmo(parameters[0], parameters[1]);
        }
        else if (parameters.Length == 3)
        {
            directResults = quotes.ToPmo(parameters[0], parameters[1], parameters[2]);
        }
        else
        {
