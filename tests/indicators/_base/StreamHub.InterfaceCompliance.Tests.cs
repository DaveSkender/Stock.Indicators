...
public class StreamHubInterfaceComplianceTests
{
    private static readonly Dictionary<string, (Type hubType, Type[] expectedInterfaces)> _expectations = new()
    {
        ...
        ["EmaHubTests"] = (typeof(ITestChainObserver), [typeof(ITestChainObserver), typeof(ITestChainProvider)]),
        ["SmaHubTests"] = (typeof(ITestChainObserver), [typeof(ITestChainObserver), typeof(ITestChainProvider)]),
        ["RsiHubTests"] = (typeof(ITestChainObserver), [typeof(ITestChainObserver), typeof(ITestChainProvider)]),
        ["MacdHubTests"] = (typeof(ITestChainObserver), [typeof(ITestChainObserver), typeof(ITestChainProvider)]),
        
        // ChainProvider<IQuote, T> should have ITestQuoteObserver + ITestChainProvider
        ["AdxHubTests"] = (typeof(ITestQuoteObserver), [typeof(ITestQuoteObserver), typeof(ITestChainProvider)]),
        ["AtrHubTests"] = (typeof(ITestQuoteObserver), [typeof(ITestQuoteObserver), typeof(ITestChainProvider)]),
        ["CciHubTests"] = (typeof(ITestQuoteObserver), [typeof(ITestQuoteObserver), typeof(ITestChainProvider)]),
        ["BollingerBandsStreamHubTests"] = (typeof(ITestQuoteObserver), [typeof(ITestQuoteObserver), typeof(ITestChainProvider)]),
        
        // PairsProvider<T> should have only ITestPairsObserver
        ["BetaHub"] = (typeof(ITestPairsObserver), [typeof(ITestPairsObserver)]),
        ["CorrelationHub"] = (typeof(ITestPairsObserver), [typeof(ITestPairsObserver)]),
        ["PrsHub"] = (typeof(ITestPairsObserver), [typeof(ITestPairsObserver)]),
        
        // StreamHub<IQuote, T> should have only ITestQuoteObserver
        ["PivotsHubTests"] = (typeof(ITestQuoteObserver), [typeof(ITestQuoteObserver)]),
        ["ChandelierHubTests"] = (typeof(ITestQuoteObserver), [typeof(ITestQuoteObserver)]),
        
        // StreamHub<IReusable, T> should have only ITestChainObserver
        ["AlligatorHubTests"] = (typeof(ITestChainObserver), [typeof(ITestChainObserver)]),
        ["MaEnvelopesHubTests"] = (typeof(ITestChainObserver), [typeof(ITestChainObserver)]),
    };
            ...
            if (expectedInterfaces.Length == 1 && actualInterfaces.Length > 1)
            {
                foreach (Type actualInterface in actualInterfaces)
                {
                    if (!expectedInterfaces.Contains(actualInterface) 
                        && actualInterface.Name != "ITestQuoteObserver") // ITestChainObserver inherits ITestQuoteObserver
                    {
    ...
    public void PairsObserver_DoesNotImplementQuoteObserver()
    {
        ...
        if (violations.Count > 0)
        {
            string message = $"Found {violations.Count} PairsObserver tests incorrectly implementing QuoteObserver or ChainObserver:\n" 
