...
public class StdDevChannelsTests : TestBase
{
    ...
    public void StdDevChannelsSeriesListing()
    {
        ...
        IndicatorParam stdDeviationsParam1 = listing.Parameters.SingleOrDefault(p => p.ParameterName == "stdDeviations");
        stdDeviationsParam1.Should().NotBeNull();

        listing.Results.Should().NotBeNull();
        listing.Results.Should().HaveCount(3);

        IndicatorResult upperchannelResult = listing.Results.SingleOrDefault(r => r.DataName == "UpperChannel");
        ...
        IndicatorResult lowerchannelResult2 = listing.Results.SingleOrDefault(r => r.DataName == "LowerChannel");
