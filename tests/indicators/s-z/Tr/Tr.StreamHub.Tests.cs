...
[TestClass]
public class TrHubTests : StreamHubTestBase, ITestBarObserver, ITestChainProvider
{
    [TestMethod]
    public void BarObserver_WithWarmupLateArrivalAndRemoval_MatchesSeriesExactly()
    {
        ...
        IReadOnlyList<TrResult> expectedOriginal = Bars.ToTr();
        sut.IsExactly(expectedOriginal);

        // delete, should equal series (revised)
        barHub.RemoveAt(removeAtIndex);

        IReadOnlyList<TrResult> expectedRevised = RevisedBars.ToTr();
    ...
    public void WithCachePruning_MatchesSeriesExactly()
    {
        ...
        IReadOnlyList<TrResult> expected = bars
            .ToTr()
    ...
    public void ChainProvider_MatchesSeriesExactly()
    {
        ...
        // initialize observer
        IChainProvider<TrResult> adlHub = barHub
            .ToTrHub();
