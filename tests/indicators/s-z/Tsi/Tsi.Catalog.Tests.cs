...
public class TsiTests : TestBase
{
    ...
    public void TsiSeriesFromCatalogMatchesDirectCall()
    {
        ...
        {
            directResults = quotes.ToTsi(parameters[0]);
        }
        else if (parameters.Length == 2)
        {
            directResults = quotes.ToTsi(parameters[0], parameters[1]);
        }
        else if (parameters.Length == 3)
        {
            directResults = quotes.ToTsi(parameters[0], parameters[1], parameters[2]);
        }
        else
        {
