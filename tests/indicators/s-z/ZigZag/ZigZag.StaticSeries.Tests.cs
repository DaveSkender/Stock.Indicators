...
public class ZigZag : StaticSeriesTestBase
{
    ...
    public void NoEntry_ThresholdNeverMet_ReturnsExpected()
    {
        ...
        string json = File.ReadAllText("_data/issues/issue0616.quotes.zigzag.thresholds.json");
    ...
    {
        // thresholds are never met
        string json = File.ReadAllText("_data/issues/issue0632.quotes.zigzag.thresholds.json");
    ...
    {
        string json = File.ReadAllText("_data/issues/issue0616.quotes.zigzag.schrodinger.json");
