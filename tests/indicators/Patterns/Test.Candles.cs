...
namespace Internal.Tests
{
    ...
    public class Candles : TestBase
    {
        ...
        public void SortCandles()
        {
            ...
            // sort
            ReadOnlyCollection<Candle> h = quotes.SortCandles();
        ...
        {
            // sort
            ReadOnlyCollection<Candle> results = quotes.SortCandles();
            ...
            Assert.AreEqual(0.19m, r0.RealBody);
            Assert.AreEqual(0.55m, r0.UpperWick);
            Assert.AreEqual(1.09m, r0.LowerWick);
            Assert.AreEqual(0.10383m, Math.Round(r0.RealBodyPct, 5));
            ...
            Assert.AreEqual(0m, r351.RealBody);
            Assert.AreEqual(0.69m, r351.UpperWick);
            Assert.AreEqual(0.55m, r351.LowerWick);
            Assert.AreEqual(0m, Math.Round(r351.RealBodyPct, 5));
            ...
            Assert.AreEqual(0.36m, r501.RealBody);
            Assert.AreEqual(0.26m, r501.UpperWick);
            Assert.AreEqual(2.05m, r501.LowerWick);
            Assert.AreEqual(0.13483m, Math.Round(r501.RealBodyPct, 5));
