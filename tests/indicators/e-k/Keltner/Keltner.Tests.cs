...
public class Keltner : TestBase
{
    ...
    public void Standard()
    {
        ...
        Assert.AreEqual(275.4260m, NullMath.Round(r1.UpperBand, 4));
        Assert.AreEqual(265.4599m, NullMath.Round(r1.Centerline, 4));
        Assert.AreEqual(255.4938m, NullMath.Round(r1.LowerBand, 4));
        Assert.AreEqual(0.075085m, NullMath.Round(r1.Width, 6));

        KeltnerResult r2 = results[501];
        Assert.AreEqual(262.1873m, NullMath.Round(r2.UpperBand, 4));
        Assert.AreEqual(249.3519m, NullMath.Round(r2.Centerline, 4));
        Assert.AreEqual(236.5165m, NullMath.Round(r2.LowerBand, 4));
        Assert.AreEqual(0.102950m, NullMath.Round(r2.Width, 6));
    }
    ...
    public void Removed()
    {
        ...
        Assert.AreEqual(262.1873m, NullMath.Round(last.UpperBand, 4));
        Assert.AreEqual(249.3519m, NullMath.Round(last.Centerline, 4));
        Assert.AreEqual(236.5165m, NullMath.Round(last.LowerBand, 4));
        Assert.AreEqual(0.102950m, NullMath.Round(last.Width, 6));
    }
