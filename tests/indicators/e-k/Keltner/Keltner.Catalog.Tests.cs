...
public class KeltnerTests : TestBase
{
    ...
    public void KeltnerSeriesFromCatalogMatchesDirectCall()
    {
        ...
        {
            directResults = quotes.ToKeltner((int)parameters[0]);
        }
        else if (parameters.Length == 2)
        {
            directResults = quotes.ToKeltner((int)parameters[0], (double)parameters[1]);
        }
        else if (parameters.Length == 3)
        {
            directResults = quotes.ToKeltner((int)parameters[0], (double)parameters[1], (int)parameters[2]);
        }
        else
        {
