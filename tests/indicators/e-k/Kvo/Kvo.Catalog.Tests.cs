...
public class KvoTests : TestBase
{
    ...
    public void KvoSeriesFromCatalogMatchesDirectCall()
    {
        ...
        {
            directResults = quotes.ToKvo((int)parameters[0]);
        }
        else if (parameters.Length == 2)
        {
            directResults = quotes.ToKvo((int)parameters[0], (int)parameters[1]);
        }
        else if (parameters.Length == 3)
        {
            directResults = quotes.ToKvo((int)parameters[0], (int)parameters[1], (int)parameters[2]);
        }
        else
        {
