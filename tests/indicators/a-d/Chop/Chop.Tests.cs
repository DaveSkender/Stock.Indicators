...
public class Chop : TestBase
{
    ...
    public void Standard()
    {
        ...
        Assert.AreEqual(69.9967m, NullMath.Round(r2.Chop, 4));

        ChopResult r3 = results[249];
        Assert.AreEqual(41.8499m, NullMath.Round(r3.Chop, 4));

        ChopResult r4 = results[501];
        Assert.AreEqual(38.6526m, NullMath.Round(r4.Chop, 4));
    }
    ...
    public void Removed()
    {
        ...
        Assert.AreEqual(38.6526m, NullMath.Round(last.Chop, 4));
    }
