...
public class QuoteAggregateTests : TestQuoteBase
{
    ...
    public void Aggregate()
    {
        ...
        // sample values
        Quote r0 = results[0];
        Assert.AreEqual(DateTime.Parse("2020-12-15 09:30", EnglishCulture), r0.TickDate);
        ...
        Quote r1 = results[1];
        Assert.AreEqual(DateTime.Parse("2020-12-15 09:45", EnglishCulture), r1.TickDate);
        ...
        Quote r2 = results[2];
        Assert.AreEqual(DateTime.Parse("2020-12-15 10:00", EnglishCulture), r2.TickDate);
    ...
    public void AggregateMonth()
    {
        ...
        // sample values
        Quote r0 = results[0];
        Assert.AreEqual(DateTime.Parse("2017-01-01", EnglishCulture), r0.TickDate);
        ...
        Quote r1 = results[1];
        Assert.AreEqual(DateTime.Parse("2017-02-01", EnglishCulture), r1.TickDate);
        ...
        Assert.AreEqual(DateTime.Parse("2018-12-01", EnglishCulture), r23.TickDate);
