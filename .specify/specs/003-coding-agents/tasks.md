...
- [X] T001 Verify existing StreamHub agent family structure (`.github/cheatsheets/streamhub*.agent.md`) - document YAML frontmatter pattern, section organization, and file size constraints for reuse in new agents
...
- [X] T027 [P] Run markdownlint-cli2 on all agent definition files - verify `.github/cheatsheets/indicator-series.agent.md`, `.github/cheatsheets/indicator-buffer.agent.md`, `.github/cheatsheets/indicator-stream.agent.md` pass linting
...
Task T011: "Create .github/cheatsheets/indicator-series.agent.md"
