...
| ------- | ---- | ----------- |
| `.specify/**,.github/prompts/speckit.*` | [spec-kit.instructions.md](file:instructions/spec-kit.instructions.md) | Spec Kit development workflow and artifact editing guidelines |
| `src/**` | [agents.md](file:../src/agents.md) | **CRITICAL**: Formula change rules and mathematical precision requirements for AI agents |
| `src/**/*.*Series.cs,tests/**/*.*Series.Tests.cs` | [indicator-series.instructions.md](file:instructions/indicator-series.instructions.md) | Series-style indicator development and testing guidelines |
| `src/**/*.StreamHub.cs,tests/**/*.StreamHub.Tests.cs` | [indicator-stream.instructions.md](file:instructions/indicator-stream.instructions.md) | Stream indicator development guidelines |
| `src/**/*.BufferList.cs,tests/**/*.BufferList.Tests.cs` | [indicator-buffer.instructions.md](file:instructions/indicator-buffer.instructions.md) | Buffer indicator development guidelines |
| `**/src/**/*.Catalog.cs,**/tests/**/*.Catalog.Tests.cs` | [catalog.instructions.md](file:instructions/catalog.instructions.md) | Catalog file conventions |
| `src/**,tests/**` | [source-code-completion.instructions.md](file:instructions/source-code-completion.instructions.md) | Source code, testing, and pre-commit code completion checklist |
| `**/*.md` | [markdown.instructions.md](file:instructions/markdown.instructions.md) | Markdown formatting rules |
| `docs/**` | [documentation.instructions.md](file:instructions/documentation.instructions.md) | Documentation website instructions |
| `tools/performance/**` | [performance-testing.instructions.md](file:instructions/performance-testing.instructions.md) | Performance testing and benchmarking guidelines |
...
- Series: [indicator-series.instructions.md](file:instructions/indicator-series.instructions.md)
- Buffer: [indicator-buffer.instructions.md](file:instructions/indicator-buffer.instructions.md)
- Stream: [indicator-stream.instructions.md](file:instructions/indicator-stream.instructions.md)
...
This repository uses [Spec Kit](https://github.com/github/spec-kit) for Specification-Driven Development. Before adding or changing indicators, consult the relevant spec in [.specify/specs/](file:../.specify/specs/) and use chat commands to align with the active plan.
...
For detailed Spec Kit workflow guidance, see [spec-kit.instructions.md](file:instructions/spec-kit.instructions.md).
