...
- [ ] CHK105 - Are requirements specified for documenting streaming capability summary in migration guide (`src/MigrationGuide.V3.md`)? [Completeness, Plan §Documentation Updates, Task T109/D007]
