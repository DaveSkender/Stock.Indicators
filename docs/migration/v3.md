...
### Step 0: Replace the NuGet package

We've renamed the NuGet package from `Skender.Stock.Indicators` to `FacioQuo.Stock.Indicators`, so you'll have to search and replace your `usings` statements in your codebase after installing it.
