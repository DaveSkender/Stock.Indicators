...
This example is also included in our [example usage code](/examples/).

## STEP 1: Create the Results class

Create your results class by extending the library `ResultBase` class.  This will allow you to inherit many of the [utility functions](/utilities#utilities-for-indicator-results), such as `RemoveWarmupPeriods()`.
